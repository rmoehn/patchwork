...
class RootQuestionSession(Session):
    ...
    def choose_promise(self, root: Address) -> Address:
        ...
        Note that within this method, "root" has nothing to do with the root
        question. But I have to use the same word, because there is a tree of
        hypertext objects and the root of a tree is called, well, "root".
